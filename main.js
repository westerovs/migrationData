import {version3, version3_5, version4, version5, version6, yandexVersion} from './src/testData.js'
import {createProfileProxy} from './src/utils/utils.js'
import FlatData from './src/FlatData.js'

const flatData = new FlatData()
const rawData  = flatData.getData(yandexVersion)
console.warn('--------- rawData --------')
Object.entries(rawData).forEach(([key, value]) => console.log(key, value))
